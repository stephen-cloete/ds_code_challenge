...
Files needed:
Output file: "service_request.csv" file gets generated by this application.
Run: python 2-initial_data_transformation.py
"""
...
if os.path.exists('sr_dataset/sr.csv'):
